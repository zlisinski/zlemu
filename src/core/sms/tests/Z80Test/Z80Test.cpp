...
void Z80Test::RunInstructionTest(const QString &opcodeName, const QString &opcode)
{
    ...
    for (int i = 0; i < array.size(); i++)
    {
        ...
        if (opcode == "37" || opcode == "3F")
        {
            // Ignore the x and y flags for CCF and SCF. I don't feel like implementing the Q register right now.
            EXPECT_EQ((cpu->reg.f & ~0x28), (final["f"].toInt() & ~0x28)) << testName;
        }
        else
        {
...
std::vector<TestOpcodeInfo> GetTestingOpcodes()
{
    ...
    uint8_t implemented[] = {
        ...
        0x02, 0x12, 0x22, 0x32, 0x36,
        0x01, 0x11, 0x21, 0x31, 0xF9,
        ...
        0x07, 0x0F, 0x17, 0x1F,
        0xC3, 0xC2, 0xCA, 0xD2, 0xDA, 0xE2, 0xEA, 0xF2, 0xFA, 0xE9, 0x18, 0x20, 0x28, 0x30, 0x38, 0x10,
    ...
    uint8_t implementedED[] = {
        ...
        0x4A, 0x5A, 0x6A, 0x7A, 0x42, 0x52, 0x62, 0x72, 0x44,
        0x6F, 0x67,
        0x45, 0x4D,
        0x46, 0x4E, 0x56, 0x5E,
